...
<div id="men_head">
      ...
      <img src="<?php echo base_url();?>pictures/women_collection.png" alt="men_collection">
</div>
   ...
   ?>
    ...
    <div class="col-md-4">
      <div class="thumbnail" id="men-collection-col">
        <img src="<?php echo base_url();?>uploads/<?php echo $row->Upload_Path;?>" alt="women_collection">
...
<?php if($this->session->userdata('logged_in')){
  echo anchor('all_collections/edit/'.$row->ID_Produk, '<button type="submit" class="btn btn-primary">
            <span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>
             Edit</button>');
   echo str_repeat('&nbsp;', 2);
echo anchor('all_collections/delete/'.$url.'/'.$row->ID_Produk, '<button type="submit" class="btn btn-danger">
